...
FCKToolbarItems.GetItem = function( itemName )
{
	...
	switch ( itemName )
	{
		...
		case 'Source'			: oItem = new FCKToolbarButton( 'Source'	, FCKLang.Source, null, null, null, null, 1 ) ; break ;
		...
		case 'Save'				: oItem = new FCKToolbarButton( 'Save'		, FCKLang.Save, null, null, null, null, 3 ) ; break ;
